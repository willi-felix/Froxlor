...
return [
	...
	'2fa' => [
		'2fa' => 'Tùy chọn xác thực hai yếu tố',
		'2fa_enabled' => 'Kích hoạt xác thực hai yếu tố (2FA)',
		'2fa_removed' => 'Đã xóa xác thực hai yếu tố',
		'2fa_added' => 'Đã kích hoạt xác thực hai yếu tố<br><a class="alert-link" href="%s?page=2fa">Xem chi tiết thông tin 2FA</a>',
		'2fa_add' => 'Kích hoạt xác thực hai yếu tố',
		'2fa_delete' => 'Hủy kích hoạt xác thực hai yếu tố',
		'2fa_verify' => 'Mã xác minh',
		'2fa_overview_desc' => 'Tại đây bạn có thể kích hoạt xác thực hai yếu tố cho tài khoản của mình.<br><br>Bạn có thể sử dụng ứng dụng xác thực (mật khẩu một lần theo thời gian / TOTP) hoặc để froxlor gửi cho bạn email đến địa chỉ tài khoản của bạn sau mỗi lần đăng nhập thành công bằng mật khẩu một lần.',
		'2fa_email_desc' => 'Tài khoản của bạn được thiết lập để sử dụng mật khẩu một lần qua email. Để hủy kích hoạt, hãy nhấp vào "Hủy kích hoạt xác thực hai yếu tố"',
		'2fa_ga_desc' => 'Tài khoản của bạn được thiết lập để sử dụng mật khẩu một lần theo thời gian thông qua ứng dụng xác thực. Vui lòng quét mã QR bên dưới bằng ứng dụng xác thực mong muốn của bạn để tạo mã. Để hủy kích hoạt, hãy nhấp vào "Hủy kích hoạt xác thực hai yếu tố"',
		'2fa_not_activated' => 'Xác thực hai yếu tố không được bật',
		'2fa_not_activated_for_user' => 'Xác thực hai yếu tố không được bật cho người dùng hiện tại',
		'type_2fa' => 'Trạng thái xác thực hai yêu tố',
	],
	'admin' => [
		'overview' => 'Tổng quan',
		'ressourcedetails' => 'Tài nguyên đã sử dụng',
		'systemdetails' => 'Chi tiết hệ thống',
		'froxlordetails' => 'Chi tiết Froxlor',
		'installedversion' => 'Phiên bản đã cài đặt',
		'latestversion' => 'Phiên bản mới nhất',
		'lookfornewversion' => [
			'clickhere' => 'Tìm kiếm qua dịch vụ web',
			'error' => 'Lỗi khi đọc',
		],
		'resources' => 'Tài nguyên',
		'customer' => 'Khách hàng',
		'customers' => 'Khách hàng',
		'customers_list_desc' => 'Quản lý khách hàng của bạn',
		'customer_add' => 'Tạo khách hàng',
		'customer_edit' => 'Chỉnh sửa khách hàng',
		'username_default_msg' => 'Để trống cho giá trị tự động tạo',
		'password_default_msg' => 'Tự động tạo nếu trống',
		'domains' => 'Tên miền',
		'domain_add' => 'Tạo tên miền',
		'domain_edit' => 'Chỉnh sửa tên miền',
		'subdomainforemail' => 'Tên miền phụ cho tên miền email',
		'admin' => 'Quản trị viên',
		'admins' => 'Quản trị viên',
		'admin_add' => 'Tạo quản trị viên',
		'admin_edit' => 'Chỉnh sửa quản trị viên',
		'customers_see_all' => 'Có thể truy cập vào tài nguyên của quản trị viên/đại lý khác không?',
		'change_serversettings' => 'Có thể thay đổi các cài đặt máy chủ không?',
		'server' => 'Hệ thống',
		'serversettings' => 'Cài đặt',
		'serversettings_desc' => 'Quản lý hệ thống froxlor của bạn',
		'rebuildconf' => 'Xây dựng lại các tập tin cấu hình',
		'stdsubdomain' => 'Tên miền phụ chuẩn',
		'stdsubdomain_add' => 'Tạo tên miền phụ chuẩn',
		'phpenabled' => 'Kích hoạt PHP',
		'deactivated' => 'Đã hủy kích hoạt',
		'deactivated_user' => 'Hủy kích hoạt người dùng',
		'sendpassword' => 'Gửi mật khẩu',
		'ownvhostsettings' => 'Cài đặt vHost riêng',
		'configfiles' => [
			'serverconfiguration' => 'Cấu hình',
			'overview' => 'Tổng quan',
			'wizard' => 'Wizard',
			'distribution' => 'Distribution',
			'service' => 'Dịch vụ',
			'daemon' => 'Daemon',
			'http' => 'Máy chủ web (HTTP)',
			'dns' => 'Nameserver (DNS)',
			'mail' => 'Mailserver (IMAP/POP3)',
			'smtp' => 'Mailserver (SMTP)',
			'ftp' => 'Máy chủ FTP',
			'etc' => 'Khác (Hệ thống)',
			'choosedistribution' => '-- Chọn một bản phân phối --',
			'chooseservice' => '-- Chọn một dịch vụ --',
			'choosedaemon' => '-- Chọn một daemon --',
			'statistics' => 'Thống kê',
			'compactoverview' => 'Tổng quan nhỏ gọn',
			'legend' => '<h3>Bạn sắp cấu hình một dịch vụ/trình nền</h3>',
			'commands' => '<span class="text-danger">Lệnh:</span> Các lệnh này sẽ được thực hiện từng dòng với tư cách là người dùng root trong shell. Có thể sao chép toàn bộ khối và dán vào shell một cách an toàn.',
			'files' => '<span class="text-danger">Tệp cấu hình:</span> Các lệnh trước trường văn bản sẽ mở trình soạn thảo với tệp đích. Chỉ cần sao chép và dán nội dung vào trình soạn thảo và lưu tệp.<br><span class="text-danger">Xin lưu ý:</span> Mật khẩu MySQL chưa được thay thế vì lý do bảo mật. Vui lòng tự thay thế "FROXLOR_MYSQL_PASSWORD" hoặc sử dụng biểu mẫu javascript bên dưới để thay thế tại chỗ. Nếu bạn quên mật khẩu MySQL, bạn sẽ tìm thấy nó trong "lib/userdata.inc.php"',
			'importexport' => 'Nhập/Xuất',
			'finishnote' => 'Tệp tham số đã được tạo thành công. Bây giờ hãy chạy lệnh sau với tư cách là root:',
			'description' => 'Cấu hình các dịch vụ hệ thống',
			'minihowto' => 'Trên trang này, bạn có thể xem các mẫu cấu hình khác nhau cho từng dịch vụ, (cấu hình lại) các dịch vụ cụ thể nếu cần hoặc xuất lựa chọn hiện tại sang tệp JSON để sử dụng trong các tập lệnh CLI hoặc trên máy chủ khác.<br><br><b>Lưu ý</b> rằng các dịch vụ được tô sáng không phản ánh thiết lập hiện tại của bạn mà hiển thị các yêu cầu/khuyến nghị từ các giá trị thiết lập hiện tại của bạn.',
			'skipconfig' => 'Không cấu hình lại',
			'recommendednote' => 'Các dịch vụ được đề xuất/yêu cầu dựa trên cài đặt hệ thống hiện tại',
			'selectrecommended' => 'Chọn đề xuất',
			'downloadselected' => 'Xuất thông tin các tùy chọn',
		],
		'templates' => [
